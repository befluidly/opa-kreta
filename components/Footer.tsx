      ...
      <div className="max-w-screen-xl mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-gray-700">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/gidsen/natuur-en-wandelen/de-mooiste-kloven" className="hover:text-skyBlue transition">De mooiste kloven van Kreta</a></li>
        ...
        <div>
          ...
          <form className="flex flex-col sm:flex-row gap-2">
            ...
            <button
              type="submit"
              className="bg-skyBlue text-white font-semibold px-4 py-2 rounded hover:bg-skyBlue/80 transition"
            >
              Inschrijven
            </button>
          </form>
