...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        nl: `https://www.opakreta.be/categorie/${category}`,
        en: `https://www.opakreta.be/en/categorie/${category}`,
        "x-default": `https://www.opakreta.be/categorie/${category}`,
      },
    },
    openGraph: {
      title: pageTitle,
...
export default async function EnglishCategoryPage({ params }: PageProps) {
  ...
  const breadcrumbJsonLd = buildBreadcrumbListJsonLd(
    buildCategoryBreadcrumbItems(category, pageTitle, "en")
  );
