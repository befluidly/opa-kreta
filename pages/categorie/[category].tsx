...
export default function CategoryPage({ category, posts }: CategoryPageProps) {
  // ✅ Titel, subtitel en hero-afbeeldingen per categorie
  ...
  const heroMap: Record<string, string> = {
    ...
    gidsen:
      "https://images.pexels.com/photos/13725168/pexels-photo-13725168.jpeg",
    praktisch:
    ...
    recepten:
      "https://images.pexels.com/photos/13054466/pexels-photo-13054466.jpeg",
  };
  ...
  const subcategories = Array.from(
    new Set(
      posts.flatMap((p) => p.subcategories || []).filter(Boolean)
    )
  ).sort();
  ...
  return (
    <Layout>
      ...
      <NextSeo
        ...
        canonical={`https://www.opakreta.be/categorie/${category}`}
        openGraph={{
          title: pageTitle,
          description: pageSubtitle,
          url: `https://www.opakreta.be/categorie/${category}`,
